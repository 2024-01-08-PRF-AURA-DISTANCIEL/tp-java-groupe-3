...
public class PokemonUtils {
    ...
    public static Map<String, Object> initMapAttack() {
        ...
        mapAirAttack.put("AIR", 0.7);
        mapAirAttack.put("EAU", Double.valueOf(1));
        mapAirAttack.put("INSECTE", 1.3);
        mapAirAttack.put("PLANTE", Double.valueOf(1));
        Map<String, Double> mapInsecteAttack = new HashMap<>();
        mapAirAttack.put("AIR", Double.valueOf(1));
        mapAirAttack.put("EAU", 0.7);
        mapAirAttack.put("INSECTE", Double.valueOf(1));
        mapAirAttack.put("PLANTE", 1.3);
        Map<String, Double> mapPlanteAttack = new HashMap<>();
        mapAirAttack.put("AIR", 1.3);
        mapAirAttack.put("EAU", Double.valueOf(1));
        mapAirAttack.put("INSECTE", 0.7);
        mapAirAttack.put("PLANTE", Double.valueOf(1));
